...
_MANIFEST_SLUGS = frozenset({
    "gmail", "github", "notion", "vercel", "n8n", "gamma",
    "canva", "pitchdeck", "visualization", "web_search",
})
...
_register_manifest("discord", "Discord Webhook Dispatch",
    "Send messages, read channel history, manage guild members, and automate server moderation.",
    "Communication", "https://mcp.discord.com/mcp", "oauth2",
    docs_url="https://discord.com/developers/docs")

_register_manifest("twilio", "Twilio SMS & Messaging",
    "Send SMS, query message logs, manage phone numbers, and automate text-based notifications.",
    "Communication", "https://mcp.twilio.com/mcp", "api_key",
    docs_url="https://www.twilio.com/docs")

_register_manifest("zoom", "Zoom Meetings Scheduler",
    "Create meetings, list upcoming events, manage participants, and pull attendance transcripts.",
    "Communication", "https://mcp.zoom.us/mcp", "oauth2",
    docs_url="https://developers.zoom.us/docs")

_register_manifest("google-calendar", "Google Calendar Invites",
    "Read events, create invites, update schedules, and sync availability across calendar views.",
    "Communication", "https://mcp.googleapis.com/calendar/mcp", "oauth2",
    docs_url="https://developers.google.com/calendar")

_register_manifest("medium", "Medium Publisher",
    "Create and publish stories, manage publications, and analyze post performance metrics.",
    "Communication", "https://mcp.medium.com/mcp", "oauth2",
    docs_url="https://medium.com/mcp/docs")

# ── Development ────────────────────────────────────────────────────────────
_register_manifest("gitlab", "GitLab Pipelines",
    "Browse repositories, create merge requests, trigger CI pipelines, and manage project members.",
    "Development", "https://mcp.gitlab.com/mcp", "pat_bearer",
    docs_url="https://docs.gitlab.com/ee/api/")

_register_manifest("jira", "Jira Workflows",
    "Create and search issues, manage sprints, query project boards, and transition workflow statuses.",
    "Development", "https://mcp.atlassian.com/jira/mcp", "oauth2",
    docs_url="https://developer.atlassian.com/cloud/jira")

_register_manifest("linear", "Linear Agile Tracker",
    "Create and assign issues, manage projects and cycles, query team roadmaps, and update issue states.",
    "Development", "https://mcp.linear.app/mcp", "oauth2",
    docs_url="https://developers.linear.app")

_register_manifest("trello", "Trello Agile Boards",
    "Manage boards, lists, and cards; assign members, set due dates, and track project progress.",
    "Development", "https://mcp.trello.com/mcp", "oauth2",
    docs_url="https://developer.atlassian.com/cloud/trello")

_register_manifest("clickup", "ClickUp Tasks",
    "Create tasks, manage lists and folders, track time, and automate team workflows.",
    "Development", "https://mcp.clickup.com/mcp", "oauth2",
    docs_url="https://clickup.com/api")

_register_manifest("figma", "Figma Artboard Inspector",
    "Read design files, inspect layers and components, extract styles, and manage team libraries.",
    "Development", "https://mcp.figma.com/mcp", "pat_bearer",
    docs_url="https://www.figma.com/developers")

_register_manifest("docker", "Docker Engine Daemon",
    "List containers, inspect images, manage volumes, and monitor engine resource usage.",
    "Development", "https://mcp.docker.com/mcp", "api_key",
    docs_url="https://docs.docker.com/engine/api/",)

_register_manifest("redis", "Redis Server Memory",
    "Execute commands, inspect keys, monitor memory usage, and manage cache clusters.",
    "Development", "https://mcp.redis.com/mcp", "pat_bearer",
    docs_url="https://redis.io/docs/")

# ── Data & DBs ─────────────────────────────────────────────────────────────
_register_manifest("postgres", "PostgreSQL Database Inspect",
    "Query tables, inspect schemas, run EXPLAIN plans, and manage database migrations.",
    "Data & DBs", "https://mcp.postgres.com/mcp", "pat_bearer",
    docs_url="https://www.postgresql.org/docs/")

_register_manifest("snowflake", "Snowflake Warehouse SQL",
    "Run SQL queries, list schemas, manage warehouses, and monitor query performance.",
    "Data & DBs", "https://mcp.snowflake.com/mcp", "pat_bearer",
    docs_url="https://docs.snowflake.com/en/developer-guide")

_register_manifest("airtable", "Airtable Custom Bases",
    "Query records, manage bases and tables, update fields, and automate data workflows.",
    "Data & DBs", "https://mcp.airtable.com/mcp", "oauth2",
    docs_url="https://airtable.com/developers")

_register_manifest("elasticsearch", "Elasticsearch Index",
    "Search indices, manage mappings, analyze query performance, and monitor cluster health.",
    "Data & DBs", "https://mcp.elastic.co/mcp", "api_key",
    docs_url="https://www.elastic.co/guide")

_register_manifest("firebase", "Firebase Cloud Auth",
    "Manage users, verify tokens, configure auth providers, and monitor authentication logs.",
    "Data & DBs", "https://mcp.firebase.com/mcp", "oauth2",
    docs_url="https://firebase.google.com/docs")

_register_manifest("aws-s3", "AWS S3 Cloud Buckets",
    "List buckets, upload/download objects, manage access policies, and monitor storage usage.",
    "Data & DBs", "https://mcp.aws.com/s3/mcp", "api_key",
    docs_url="https://docs.aws.amazon.com/s3/")

# ── AI & Search ────────────────────────────────────────────────────────────
_register_manifest("brave-search", "Brave Search Engine",
    "Perform web searches, retrieve news results, fetch local business data, and aggregate answer boxes.",
    "AI & Search", "https://mcp.brave.com/search/mcp", "api_key",
    docs_url="https://brave.com/search/api/")

_register_manifest("huggingface", "HuggingFace Model Index",
    "Query model catalog, read model cards, list datasets, and trigger inference requests.",
    "AI & Search", "https://mcp.huggingface.co/mcp", "api_key",
    docs_url="https://huggingface.co/docs")

_register_manifest("exa-search", "Exa Neural Search",
    "Perform semantic searches, query content indexes, retrieve web embeddings, and analyze link graphs.",
    "AI & Search", "https://mcp.exa.ai/mcp", "api_key",
    docs_url="https://docs.exa.ai")

_register_manifest("youtube", "YouTube Data API",
    "Search videos, get channel stats, list playlists, and retrieve transcript metadata.",
    "AI & Search", "https://mcp.youtube.com/mcp", "api_key",
    docs_url="https://developers.google.com/youtube")

_register_manifest("wikipedia", "Wikipedia Encyclopedia",
    "Search articles, get page summaries, list categories, and retrieve cross-language links.",
    "AI & Search", "https://mcp.wikipedia.org/mcp", "none",
    docs_url="https://www.mediawiki.org/wiki/API")

_register_manifest("google-maps", "Google Maps Navigation",
    "Geocode addresses, search places, calculate routes, and retrieve real-time traffic data.",
    "AI & Search", "https://mcp.googleapis.com/maps/mcp", "api_key",
    docs_url="https://developers.google.com/maps")

# ── Productivity / CRM / Sales ─────────────────────────────────────────────
_register_manifest("salesforce", "Salesforce CRM Leads",
    "Query accounts and contacts, manage opportunities, run SOQL queries, and automate pipeline tasks.",
    "Productivity", "https://mcp.salesforce.com/mcp", "oauth2",
    docs_url="https://developer.salesforce.com")

_register_manifest("hubspot", "HubSpot Contacts Tracker",
    "Manage contacts and deals, track email engagement, query pipelines, and update CRM records.",
    "Productivity", "https://mcp.hubspot.com/mcp", "oauth2",
    docs_url="https://developers.hubspot.com")

_register_manifest("zendesk", "Zendesk Help Center",
    "Manage tickets, search knowledge base articles, view user profiles, and update support workflows.",
    "Productivity", "https://mcp.zendesk.com/mcp", "oauth2",
    docs_url="https://developer.zendesk.com")

_register_manifest("shopify", "Shopify Storefront",
    "Manage products and variants, process orders, update inventory, and query customer data.",
    "Productivity", "https://mcp.shopify.com/mcp", "oauth2",
    docs_url="https://shopify.dev/docs/api")

_register_manifest("stripe", "Stripe Billing Dashboard",
    "Process payments, manage customers, create invoices, and monitor subscription lifecycle.",
    "Productivity", "https://mcp.stripe.com/mcp", "api_key",
